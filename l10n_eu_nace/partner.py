...
class PartnerCategory(models.Model):
    ...
    _name = 'res.partner.ape'

    name = fields.Char('Nom')
    parent_left = fields.Many2one('res.partner.ape', string="Parent left")
    parent_right = fields.Many2one('res.partner.ape', string="Parent right")
    parent_id = fields.Many2one('res.partner.ape', string="Parent id")
